...
int main(void)
{
  ...
  SEGGER_RTT_ConfigUpBuffer(JscopeChannel,                  // 通道号
                            ...
                            "JScope_u1i1",                  // 数据包含1个uint8_t的变量与一个int8_t的变量
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    if (htim == (&htim14))
    {
        ...
        // 将数据放入消息包
        rtt_JsMsg.msg_u8 = sineValue;
        rtt_JsMsg.msg_i8 = numbool;
